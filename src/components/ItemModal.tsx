    ...
    <div className="mt-5">
      ...
      <div className="flex justify-end">
        ...
        <button
          type="button"
          onClick={() => submit(item)}
          className="group rounded bg-indigo-500 px-4 py-2 font-bold text-white hover:bg-indigo-700"
        >
          Submit{" "}
...
export const ItemModal: React.FC<ItemModalProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 h-full overflow-y-hidden ${
        show ? "" : "hidden"
      }`}
    >
      <div className="flex min-h-screen items-start justify-center px-4 pb-20 pt-4 text-center">
        ...
        {/* <div className="inline-block w-full transform overflow-hidden rounded-lg bg-white text-left align-middle"> */}
        <div
          className={`
                      inline-block 
                      w-full
